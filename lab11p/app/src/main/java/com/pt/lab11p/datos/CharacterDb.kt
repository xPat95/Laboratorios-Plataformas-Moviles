package com.pt.lab11p.datos

class CharacterDb {

    //Constructor de los personajes: id, name, status, species, gender, image.
    ...
    //Metodo para obtener a los personajes.
    fun getAllCharacters(): List<Character> {
        return characters
    }

    //Metodo para obtener a los personajes por su id.
